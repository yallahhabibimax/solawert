...
const LeadQuiz = () => {
  ...
  const rail = h("div", { className: "lq-rail" },
    ...
    h("div", { className: "lq-google", style: { display: "flex", flexDirection: "column", alignItems: "stretch", gap: ".8rem" } },
      h("div", { style: { display: "flex", alignItems: "center", gap: ".7rem" } },
      ...
      h("div", { style: { display: "flex", flexDirection: "column", gap: ".5rem" } }, ["100% kostenlos & unverbindlich", "In nur 30 Sekunden erledigt"].map(function (t, i) { return h("div", { key: i, style: { display: "flex", alignItems: "center", gap: ".5rem", color: "rgba(255,255,255,0.85)", fontFamily: "'Archivo',sans-serif", fontWeight: 600, fontSize: "12.5px" } }, h("span", { style: { width: "18px", height: "18px", borderRadius: "50%", background: "#F5B301", color: "#1A1402", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 } }, h(Svg, { size: 11, sw: 3 }, ICO.check)), t); }))));
