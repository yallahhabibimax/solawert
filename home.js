  ...
  const rail = h("div", { className: "lq-rail" },
    ...
    h("div", { className: "lq-google" },
      ...
      h("div", null,
        ...
        h("div", { style: { color: "rgba(255,255,255,0.5)", fontSize: "13px" } }, "500+ Projekte in NRW"))), h("div", { style: { marginTop: "1.1rem", display: "flex", flexDirection: "column", gap: ".55rem" } }, ["100% kostenlos & unverbindlich", "In nur 30 Sekunden erledigt"].map(function (t, i) { return h("div", { key: i, style: { display: "flex", alignItems: "center", gap: ".5rem", color: "rgba(255,255,255,0.82)", fontFamily: "'Archivo',sans-serif", fontWeight: 600, fontSize: "13px" } }, h("span", { style: { width: "20px", height: "20px", borderRadius: "50%", background: "#F5B301", color: "#1A1402", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 } }, h(Svg, { size: 12, sw: 3 }, ICO.check)), t); })));
