...
/* ── Features ── */
const Features = () => {
  const items = [{"ico": ICO.euro, "title": "Klarer Festpreis, keine Überraschungen", "desc": "Sie bekommen vorab einen festen Preis, schwarz auf weiß. Keine versteckten Posten und keine Nachforderungen, nachdem die Anlage läuft."}, {"ico": ICO.leaf, "title": "Mehr Speicher zum gleichen Preis", "desc": "Der Speicher entscheidet über die Effizienz Ihrer Anlage. Wo andere knausern, um ihre Marge zu erhöhen, planen wir den Speicher passend zu Ihrem Verbrauch. Markenspeicher, individuell ausgelegt."}, {"ico": ICO.search, "title": "Wir holen das Maximum heraus", "desc": "Optimierte String-Verteilung, sauber berechnete Spannung und Strom, ein leicht überdimensionierter Wechselrichter mit Reserve für die Zukunft. Wir behandeln jedes Projekt wie unser eigenes Zuhause."}];
  return /*#__PURE__*/React.createElement("section", {
...
const WerWirSind = () => {
  const cards = [{
    ...
    desc: "Markenspeicher, individuell dimensioniert auf Ihren Verbrauch."
  }, {
    ico: ICO.check,
...
/* ── FAQ ── */
const FAQ = () => {
  const faqs = [{"q": "Bekomme ich vorab einen festen Preis?", "a": "Ja. Nach der Beratung erhalten Sie einen klaren Festpreis, schwarz auf weiß. Keine versteckten Posten und keine Nachforderungen, nachdem die Anlage läuft."}, {"q": "Wie schnell bekomme ich einen Termin für den Baubeginn?", "a": "In der Regel ist jede Baustelle innerhalb von 2 bis 4 Wochen terminiert und fertig gebaut. Wir nennen Ihnen bei der Beratung einen konkreten Zeitrahmen."}, {"q": "Wie lange dauert die Montage?", "a": "Die Dauer hängt von Anlagengröße, Dachform und Wetter ab. In der Regel arbeiten wir zügig und Sie haben nur kurz eine Baustelle am Haus. Beim Beratungstermin nennen wir Ihnen für Ihr Projekt einen konkreten Zeitrahmen."}, {"q": "Welche Garantien gibt es?", "a": "Auf die Solarmodule erhalten Sie 30 Jahre Garantie, auf Wechselrichter und Batteriespeicher jeweils 10 bis 15 Jahre. Sie sind also langfristig abgesichert."}, {"q": "Bauen Sie auch Wärmepumpen?", "a": "Ja. Wir bauen Wärmepumpen genauso schlüsselfertig wie Photovoltaik und bringen beides sinnvoll zusammen, damit Sie mit Ihrem eigenen Strom heizen."}, {"q": "Warum bekomme ich bei Ihnen mehr Speicher?", "a": "Der Speicher ist der entscheidende Effizienzfaktor einer Anlage. Viele bieten bewusst zu wenig an, um ihre Marge zu erhöhen. Wir machen das Gegenteil und geben Ihnen einen passend dimensionierten Markenspeicher."}, {"q": "In welchem Gebiet sind Sie tätig?", "a": "Unser Fokus liegt auf Nordrhein-Westfalen, von Wuppertal über Solingen und Remscheid bis Düsseldorf und Köln. Auf Wunsch sind wir aber in ganz Deutschland für Sie unterwegs."}];
  return React.createElement("section", {
    id: "faq",
