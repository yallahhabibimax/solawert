...
const LeadQuiz = () => {
  ...
  const rail = h("div", { className: "lq-rail" },
    ...
    h("div", { className: "lq-steps" }, STEPS.map(function (s, i) {
      return h("div", { key: i, className: "lq-step" + (i === step ? " is-active" : i < step ? " is-done" : "") },
        h("span", { className: "lq-step__dot" }, i < step ? h(Svg, { size: 15, sw: 2.6 }, ICO.check) : (i + 1)),
        h("span", { className: "lq-step__lbl" }, s.label));
    })),
    h("div", { className: "lq-google" },
      h("span", { className: "lq-gicon" }, "G"),
      h("div", null,
        h("div", { style: { display: "flex", alignItems: "center", gap: "0.4rem" } }, h("b", { style: { fontFamily: "'Archivo',sans-serif", fontSize: "15px", color: "#fff" } }, "4,9"), h("span", { style: { color: "#F5B301", fontSize: "13px", letterSpacing: "1px" } }, "★★★★★")),
        h("div", { style: { color: "rgba(255,255,255,0.5)", fontSize: "11.5px" } }, "500+ Projekte in NRW"))));
  ...
  const main = sent
    ? h("div", { className: "lq-main lq-done" },
        ...
        h("h3", { className: "font-heading font-black", style: { fontSize: "clamp(1.8rem,3.4vw,2.6rem)", color: "#14171C", margin: "0 0 0.5rem" } }, "Vielen Dank, " + ((a.name || "").trim().split(" ")[0] || "") + "!"),
        h("p", { style: { color: "#525A64", maxWidth: "28rem", lineHeight: "1.6", marginBottom: "1.6rem" } }, "Ihre Anfrage ist eingegangen. Wir melden uns in den meisten Fällen innerhalb von 24 Stunden mit einer ehrlichen Einschätzung."),
